...
def create_story():
    ...
    try:
        ...
        if 'friendship' in plot_starter['themes']:
            template_id = 'friendship_story'
        elif 'learning' in plot_starter['themes'] or 'discovery' in plot_starter['themes']:
        ...
        character_name = character['name']['english']
        place_name = setting['name']['english']
